...
fetch("content/project-management.json?v=20260814-ticket-details", { cache: "no-store" }).then((response) => { if (!response.ok) throw new Error("Suivi indisponible"); return response.json(); }).then((data) => {
  trackerData = data;
